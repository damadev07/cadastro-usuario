...
public class GreetingsController {
    ...
    @ResponseBody /*Descrição da resposta*/
    public ResponseEntity<String> delete(@RequestParam("idUser") Long idUser) {/*Recebe os dados para salvar*/ 
    ...
    @ResponseBody /*Descrição da resposta*/
    public ResponseEntity<Usuario> buscaruserid(@RequestParam("idUser") Long idUser) {/*Recebe os dados para consultar*/ 
    ...
    @ResponseBody /*Descrição da resposta*/
    public ResponseEntity<List<Usuario>> buscarPorNome(@RequestParam("nome") String nome) {/*Recebe os dados para consultar*/ 
